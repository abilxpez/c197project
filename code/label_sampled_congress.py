...
# File paths
CHECKPOINT_PATH = "chat_label_checkpoint_congress.json"
INPUT_FILE = "congress_sampled_unlabeled_speeches_final.json"
OUTPUT_FILE = "congress_sampled_labeled_speeches_final.json"
CHECKPOINT_INTERVAL = 50

# Set to False to skip speeches already labeled (after a crash/resume)
REPROCESS_ALL = False
...
if __name__ == "__main__":
    ...
    for i, doc in enumerate(all_documents, 1):
        ...
        if not REPROCESS_ALL and existing_labels and existing_labels != ["Unlabeled"]:
            continue
        ...
        new_batch.append(new_result)

        if len(new_batch) >= CHECKPOINT_INTERVAL:
    ...
    print(f"\nSaved all labeled speeches to {OUTPUT_FILE}")
