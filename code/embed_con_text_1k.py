...
# File paths
INPUT_FILE = "chat_label_checkpoint_congress.json"
CHECKPOINT_FILE = "embedding_checkpoint.json"
OUTPUT_JSON = "congress_sampled_labeled_speeches_embedded_10k.json"
OUTPUT_NPZ = "congress_sampled_labeled_speeches_embedded_10k.npz"
